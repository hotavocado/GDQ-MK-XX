...
const protocolName = "custom_daily_questionnaire"

//2. your protocol display name: this will show up in the app and be parsed as a string
const protocolDisplayName = "Daily Questionnaire (X.X.)"

//2. create your raw github repo URL
const userName = 'hotavocado'
const repoName = 'GDQ-MK-XX'
const branchName = 'master'

let yourRepoURL = `https://raw.githubusercontent.com/${userName}/${repoName}/${branchName}`

//3. add a description to your protocol
let protocolDescription = "Answer a daily questionnaire about your child's sleep"

//4. where are you hosting your images?
let imagePath = `https://raw.githubusercontent.com/ChildMindInstitute/Clinic-Applet-Images/main/images/png/`
...
let protocolAboutPath = `https://raw.githubusercontent.com/hotavocado/GDQ-CM-EI/main/protocols/custom_daily_questionnaire/README.md`
...
function createProtocolSchema(protocolName, protocolContextUrl) {
    let protocolSchema = {
        ...
        "schema:image": imagePath + 'CDQ.png',
